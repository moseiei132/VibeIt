namespace Loupedeck.VibeItPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.VibeItPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.VibeItPlugin.Resources.Resource.txt`.
